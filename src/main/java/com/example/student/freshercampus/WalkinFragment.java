...
public class WalkinFragment extends Fragment {
    ...
    View view= inflater.inflate(R.layout.fragment_walkin, container, false);
        getActivity().setTitle("WALK-IN");
        mWebview = (WebView) view.findViewById(R.id.webview3);
        mWebview.getSettings().setJavaScriptEnabled(true);
        mWebview.setWebViewClient(new WalkinFragment.MyWebViewClient());
        new WalkinFragment.BackgroundWorker().execute();
        return view;
    }
    ...
    private class BackgroundWorker extends AsyncTask<Void, Void, Void> {
        ...
        public void geton() {
            ...
            try {
                Document htmlDocument = Jsoup.connect("http://freshercampus.com/Walk-In.php").get();
