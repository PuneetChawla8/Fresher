...
public class OffCampusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("OFF CAMPUS");
        mWebview = (WebView) view.findViewById(R.id.webview2);
        mWebview.getSettings().setJavaScriptEnabled(true);
        mWebview.setWebViewClient(new OffCampusFragment.MyWebViewClient());
        new OffCampusFragment.BackgroundWorker().execute();
        return view;
    }
    ...
    private class BackgroundWorker extends AsyncTask<Void, Void, Void> {
        ...
        public void geton() {
            ...
            try {
                Document htmlDocument = Jsoup.connect("http://freshercampus.com/off-campus.php").get();
